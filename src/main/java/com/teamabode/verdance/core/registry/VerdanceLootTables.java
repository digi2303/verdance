...
public class VerdanceLootTables {
    public static final ResourceKey<LootTable> CHESTS_CANTALOUPE_SEEDS = createKey("chests/cantaloupe_seeds");
    public static final ResourceKey<LootTable> GAMEPLAY_SILK_COCOON_WOBBLE = createKey("gameplay/silk_cocoon_wobble");
